...
#else
#define UART_CLOCK_ENABLE     SYSCTL_RCGCUART_R5
#endif
...
#ifdef MDTTP_CM_MCU_BL_UART_FRONTPANEL
#define UART_RXPIN_CLOCK_ENABLE     SYSCTL_RCGCGPIO_R8
#else
...
#ifdef MDTTP_CM_MCU_BL_UART_FRONTPANEL
#define UART_RXPIN_BASE     GPIO_PORTJ_BASE
#else
...
#ifdef MDTTP_CM_MCU_BL_UART_FRONTPANEL
#define UART_TXPIN_CLOCK_ENABLE     SYSCTL_RCGCGPIO_R8
#else
...
#ifdef MDTTP_CM_MCU_BL_UART_FRONTPANEL
#define UART_TXPIN_BASE     GPIO_PORTJ_BASE
#else
...
#define BL_HW_INIT_FN_HOOK      BL_UserHwInit
...
#define BL_REINIT_FN_HOOK       BL_Reinit
...
#define BL_START_FN_HOOK        BL_FwDownloadStart
...
#define BL_PROGRESS_FN_HOOK     BL_FwDownloadProgress
...
#define BL_END_FN_HOOK          BL_FwDownloadEnd
...
#define BL_CHECK_UPDATE_FN_HOOK BL_UserCheckUpdateHook
