...
./pyMcuCm.py -d $1 -c clk_setup -p IC10 "IC10_150IN1_100_130_100_100_NA_NA_NA_NA_NA_FB-Registers.txt"
...
echo "Ensure that SM (MPIP005) clocks are programmed."
echo "Run clock test with"
echo "  ./clock_test -t /dev/ttyUSB1 115200 -C TC_INCR"
